...
package com.example.test.demo.aminoFrame.amino.alg.scan;
...
public class ParallelScanner extends DefaultScanner {
    ...
    public ParallelScanner() {
        numberThreads = com.example.test.demo.aminoFrame.amino.Runtime.getMaxAvailableWorkerThreads();
    }
    ...
    public int[] findAll(final byte[] a, final byte v, int from, int to) {
        ...
        final int numThreads = com.example.test.demo.aminoFrame.amino.Runtime.reserveThreads(numberThreads);
        ...
        com.example.test.demo.aminoFrame.amino.Runtime.releaseThreads(numThreads);
