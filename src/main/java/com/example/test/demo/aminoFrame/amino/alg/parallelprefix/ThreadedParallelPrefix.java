...
package com.example.test.demo.aminoFrame.amino.alg.parallelprefix;
...
public class ThreadedParallelPrefix<T> extends AbstractParallelPrefix<T> {
    ...
    public class PartialReduction {
        ...
        public int[] reduce(final int[] inputArray, final int[] reducedArray,
                            final BinaryOp<T> op) {
            int numThreads = com.example.test.demo.aminoFrame.amino.Runtime.reserveThreads(numOfThreads);
