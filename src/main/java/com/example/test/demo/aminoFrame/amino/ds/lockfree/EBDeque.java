...
package com.example.test.demo.aminoFrame.amino.ds.lockfree;

import com.example.test.demo.aminoFrame.amino.utility.AdaptEliminationArray;
import com.example.test.demo.aminoFrame.amino.utility.EliminationArray;
import com.example.test.demo.aminoFrame.amino.utility.IEliminationArray;
 ...
 * scenario. Please read about {@link com.example.test.demo.aminoFrame.amino.utility.EliminationArray} to get
 * more information. If we don't consider elimination backoff, this class
 * implements the same algorithm as {@link com.example.test.demo.aminoFrame.amino.ds.lockfree.LockFreeDeque}
 *
